                       ...
                       <Table color='orange' sortable celled>
                           ...
                           <Table.Header>
                               <Table.Row>
                                   ...
                                   <Table.HeaderCell>Tempo de entrega minima</Table.HeaderCell>
                                   <Table.HeaderCell>Tempo de entrega máxima</Table.HeaderCell>
                                   ...
                                   <Table.Row key={produto.id}>
                                       ...
                                       <Table.Cell textAlign='center'>
                                           ...
                                           <Button
                                               ...
                                               circular
                                               color='green'
                                               title='Clique aqui para editar os dados do produto'
                                               icon>
                                                    <Icon name='edit' />
                                           </Button> &nbsp;
                                                         <Button
